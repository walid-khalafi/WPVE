...
namespace WPVE.Services.Blogs
{
    ...
    public partial interface IBlogService
    {
        ...
        /// </returns>
        Task<IPagedList<BlogPost>> GetAllBlogPostsAsync( int languageId = 0,
        ...
        /// </returns>
        Task<IList<BlogComment>> GetAllCommentsAsync(int customerId = 0, string? blogPostId = null,
        ...
        /// </summary>
        /// <param name="blogCommentId">Blog comment</param>
        /// <returns>A task that represents the asynchronous operation</returns>
        Task DeleteBlogCommentAsync(string blogCommentId);
